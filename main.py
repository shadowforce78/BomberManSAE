...
def draw_map(canvas, map):
    for y, line in enumerate(map):
        for x, cell in enumerate(line):
            if cell == "C":
                canvas.create_rectangle(x * 32, y * 32, x * 32 + 32, y * 32 + 32, fill="black")
            elif cell == "M":
                canvas.create_rectangle(x * 32, y * 32, x * 32 + 32, y * 32 + 32, fill="grey")
            elif cell == "E":
                canvas.create_rectangle(x * 32, y * 32, x * 32 + 32, y * 32 + 32, fill="blue")
            elif cell == "P":
                canvas.create_rectangle(x * 32, y * 32, x * 32 + 32, y * 32 + 32, fill="red")
            elif cell == "F":
                canvas.create_rectangle(x * 32, y * 32, x * 32 + 32, y * 32 + 32, fill="purple")
            elif cell == "U":
                canvas.create_rectangle(x * 32, y * 32, x * 32 + 32, y * 32 + 32, fill="yellow")
            elif cell == "B":
                canvas.create_rectangle(x * 32, y * 32, x * 32 + 32, y * 32 + 32, fill="green")
...
def move_player(event):
    ...
    if (0 <= new_x < len(map_grid[0]) and 
        0 <= new_y < len(map_grid) and 
        map_grid[new_y][new_x] != "C" and 
        map_grid[new_y][new_x] != "M"):
